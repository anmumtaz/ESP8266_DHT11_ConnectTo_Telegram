...
float h, t;
#define WIFI_SSID "NANDA POIN"
#define WIFI_PASS "BOGEL123"

#define MAX_CONN_FAIL 50
#define MAX_LENGTH_WIFI_SSID 31
#define MAX_LENGTH_WIFI_PASS 63

#define TLG_TOKEN "1485967662:AAFlQfnWynQdSkiofohGy9jn6o3-Qi9kbKs" // token KelembabanSuhuuBot
...
void loop()
{
  ...
  if (t > 37 && state_t == 0) {
    ...
    msg.toCharArray(buff, 100);
    Bot.sendMessage("1427410757", buff);
  }
  else if (t <= 37) {
    state_t = 0;
  ...
  if (h < 60 && state_h == 0) {
    ...
    msg.toCharArray(buff, 100);
    Bot.sendMessage("1402649930", buff);
  }
  else if (h >= 60) {
    state_h = 0;
  }
